...
const ForgotPassword = () => {
  ...
  // const API_BASE = "http://127.0.0.1:8000/api/";
   const API_BASE="https://resume-project-z8ag.onrender.com/";
  ...
  const handleOtpSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // await axios.post("http://127.0.0.1:8000/api/verify-otp/", {
      await axios.post( "https://resume-project-z8ag.onrender.com/verify-otp/", {
        email: email,
        otp: otp,
      });
  ...
  const handleResetSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // const res = await axios.post("http://127.0.0.1:8000/api/reset-password/", {
      const res = await axios.post("https://resume-project-z8ag.onrender.com/reset-password/", {
        email: email,
        otp: otp,
        new_password: newPassword,
      });
