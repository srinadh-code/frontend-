...
export default function App() {
  ...
  />
      ...
      <div className="flex-1 overflow-y-auto p-12 bg-slate-200 flex justify-center">
        <div ref={resumeRef} className="w-[210mm] min-h-[297mm] bg-white shadow-2xl font-sans text-[#101820] flex">
          
          {/* SIDEBAR */}
          <div className={`w-[33%] ${activeTheme.sidebar} p-8 border-r border-slate-100 flex flex-col space-y-10 h-full`}>
            <div>
  ...
  <span className="block break-words">
    {form.last_name || "LAST"}
          ...
          {/* MAIN CONTENT */}
          <div className="w-[67%] p-12 flex flex-col space-y-12 h-full">
